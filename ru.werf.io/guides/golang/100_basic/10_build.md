...
_Так вы скопируете себе код [приложения на Node.js](https://github.com/werf/werf-guides/tree/master/examples/golang/000_app) и инициируете Git в каталоге с ним._
...
- взять официальный образ golang (`golang:1.15-alpine` подойдёт);
