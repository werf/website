...
{% snippetcut name="werf.yaml" url="https://github.com/werf/werf-guides/blob/master/examples/golang/015_deploy_app/werf.yaml" %}
{% raw %}
```yaml
---
image: basicapp
...
{% snippetcut name="werf.yaml" url="https://github.com/werf/werf-guides/blob/master/examples/golang/020_optimize_build/werf.yaml" %}
{% raw %}
```yaml
---
image: basicapp
