...
***Дописать про то что сборка собирается верфом в одну команду и не надо думать про то тчо происходит внутри, дописать про автоматическое тегирование, распределенную сборку и параллельную сборку
