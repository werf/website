...
`stages-storage` [позволяет настраивать]({{ site.docsurl }}/documentation/internals/stages_and_storage.html#%D1%85%D1%80%D0%B0%D0%BD%D0%B8%D0%BB%D0%B8%D1%89%D0%B5-%D1%81%D1%82%D0%B0%D0%B4%D0%B8%D0%B9), где будет храниться кэш сборочных стадий: на локальном сервере или в Registry.
{% endofftopic %}
...
<div id="go-forth-button">
    <go-forth url="20_iac.html" label="Конфигурирование инфраструктуры в виде кода" base-url="guides"></go-forth>
</div>
