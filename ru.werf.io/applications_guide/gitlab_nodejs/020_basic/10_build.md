...
`stages-storage` позволяет настраивать, где будет храниться кэш сборочных стадий: на локальном сервере или в Registry.
{% endofftopic %}
...
![](/applications_guide/images/applications-guide/020-hello-world-in-browser.png)
