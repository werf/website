...
rewrite ^/guides/(.+)/400_ci_cd_workflow/030_gitlab_ci_cd/030_kubernetes_executor.html   	/documentation/v1.2/index.html permanent;
...
rewrite ^/documentation(/v.+)?/advanced/ci_cd/run_in_container/use_docker_container\.html                        /documentation/v1.2/index.html permanent;
rewrite ^/documentation(/v.+)?/advanced/ci_cd/run_in_container/use_kubernetes\.html                              /documentation/v1.2/index.html permanent;
rewrite ^/documentation(/v.+)?/advanced/ci_cd/run_in_container/use_gitlab_ci_cd_with_docker_executor\.html       /documentation/v1.2/index.html permanent;
rewrite ^/documentation(/v.+)?/advanced/ci_cd/run_in_container/use_gitlab_ci_cd_with_kubernetes_executor\.html   /documentation/v1.2/index.html permanent;
