...
rewrite ^/documentation/quickstart\.html                                                   /documentation/v1.2/index.html permanent;
rewrite ^/documentation/using_with_ci_cd_systems\.html                                     /documentation/v1.2/usage/integration_with_ci_cd_systems.html permanent;
rewrite ^/documentation/advanced/giterminism\.html                                         /documentation/v1.2/usage/project_configuration/giterminism.html permanent;
rewrite ^/documentation/advanced/helm/overview\.html                                       /documentation/v1.2/usage/deploy/overview.html permanent;
rewrite ^/documentation/advanced/helm/configuration/chart\.html                            /documentation/v1.2/usage/deploy/charts.html permanent;
rewrite ^/documentation/advanced/helm/configuration/templates\.html                        /documentation/v1.2/usage/deploy/templates.html permanent;
rewrite ^/documentation/advanced/helm/configuration/values\.html                           /documentation/v1.2/usage/deploy/values.html permanent;
rewrite ^/documentation/advanced/helm/configuration/giterminism\.html                      /documentation/v1.2/usage/project_configuration/giterminism.html permanent;
rewrite ^/documentation/advanced/helm/configuration/secrets\.html                          /documentation/v1.2/usage/deploy/values.html permanent;
rewrite ^/documentation/advanced/helm/configuration/chart_dependencies\.html               /documentation/v1.2/usage/deploy/charts.html permanent;
rewrite ^/documentation/advanced/helm/deploy_process/steps\.html                           /documentation/v1.2/usage/deploy/deployment_order.html permanent;
rewrite ^/documentation/advanced/helm/deploy_process/deployment_order\.html                /documentation/v1.2/usage/deploy/deployment_order.html permanent;
rewrite ^/documentation/advanced/helm/deploy_process/helm_hooks\.html                      /documentation/v1.2/usage/deploy/deployment_order.html permanent;
rewrite ^/documentation/advanced/helm/deploy_process/external_dependencies\.html           /documentation/v1.2/usage/deploy/deployment_order.html permanent;
rewrite ^/documentation/advanced/helm/deploy_process/annotating_and_labeling\.html         /documentation/v1.2/usage/deploy/releases.html permanent;
rewrite ^/documentation/advanced/helm/deploy_process/resources_adoption\.html              /documentation/v1.2/usage/deploy/releases.html permanent;
rewrite ^/documentation/advanced/helm/releases/release\.html                               /documentation/v1.2/usage/deploy/releases.html permanent;
rewrite ^/documentation/advanced/helm/releases/naming\.html                                /documentation/v1.2/usage/deploy/releases.html permanent;
rewrite ^/documentation/advanced/helm/releases/manage_releases\.html                       /documentation/v1.2/usage/deploy/releases.html permanent;
rewrite ^/documentation/advanced/storage_layouts\.html                                     /documentation/v1.2/usage/build/process.html permanent;
rewrite ^/documentation/advanced/cleanup\.html                                             /documentation/v1.2/usage/cleanup/cr_cleanup.html permanent;
rewrite ^/documentation/advanced/bundles\.html                                             /documentation/v1.2/usage/distribute/bundles.html permanent;
rewrite ^/documentation/advanced/buildah_mode\.html                                        /documentation/v1.2/usage/build/process.html permanent;
rewrite ^/documentation/advanced/building_images_with_stapel/base_image\.html              /documentation/v1.2/usage/build/stapel/base.html permanent;
rewrite ^/documentation/advanced/building_images_with_stapel/docker_directive\.html        /documentation/v1.2/usage/build/stapel/dockerfile.html permanent;
rewrite ^/documentation/advanced/building_images_with_stapel/git_directive\.html           /documentation/v1.2/usage/build/stapel/git.html permanent;
rewrite ^/documentation/advanced/building_images_with_stapel/assembly_instructions\.html   /documentation/v1.2/usage/build/stapel/instructions.html permanent;
rewrite ^/documentation/advanced/building_images_with_stapel/mount_directive\.html         /documentation/v1.2/usage/build/stapel/mounts.html permanent;
rewrite ^/documentation/advanced/building_images_with_stapel/import_directive\.html        /documentation/v1.2/usage/build/stapel/imports.html permanent;
rewrite ^/documentation/advanced/building_images_with_stapel/artifacts\.html               /documentation/v1.2/usage/build/stapel/imports.html permanent;
rewrite ^/documentation/advanced/development_and_debug/stage_introspection\.html           /documentation/v1.2/usage/build/stapel/base.html permanent;
rewrite ^/documentation/advanced/supported_container_registries\.html                      /documentation/v1.2/usage/cleanup/cr_cleanup.html permanent;
rewrite ^/documentation/advanced/synchronization\.html                                     /documentation/v1.2/usage/build/process.html permanent;
rewrite ^/documentation/internals/stages_and_storage\.html                                 /documentation/v1.2/usage/build/process.html permanent;
rewrite ^/documentation/internals/build_process\.html                                      /documentation/v1.2/usage/build/process.html permanent;
rewrite ^/documentation/internals/integration_with_ssh_agent\.html                         /documentation/v1.2/usage/build/stapel/base.html permanent;
rewrite ^/documentation/internals/development/stapel_image\.html                           /documentation/v1.2/usage/build/stapel/base.html permanent;
rewrite ^/documentation/internals/telemetry\.html                                          /documentation/v1.2/resources/telemetry.html permanent;
