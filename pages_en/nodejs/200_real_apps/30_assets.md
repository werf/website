...
<div class="twoaccentedcolumns">
    <div class="twoaccentedcolumns__column">{% asset guides/nodejs/200_30_assets_deploy_1.png %}</div>
    <div class="twoaccentedcolumns__column">{% asset guides/nodejs/200_30_assets_deploy_2.png %}</div>
</div>
