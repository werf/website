...
asciinema rec --title "cleanup" --command "INSTANT_TYPE=1 ./scripts/demo/_type_and_execute.sh ./scripts/demo/raw_scenario/cleanup.sh" assets/demo/cleanup.cast --overwrite
