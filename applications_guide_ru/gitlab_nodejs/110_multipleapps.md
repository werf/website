...
{% snippetcut name="service-app.yaml" url="https://github.com/werf/werf-guides/tree/master/examples/gitlab-nodejs/110-multipleapps/.helm/templates/service-py.yaml" %}
{% raw %}
```yaml
---
apiVersion: v1
...
{% snippetcut name="app.yaml" url="https://github.com/werf/werf-guides/tree/master/examples/gitlab-nodejs/110-multipleapps/.helm/templates/deployment-py.yaml" %}
{% raw %}
```yaml
---
apiVersion: apps/v1
