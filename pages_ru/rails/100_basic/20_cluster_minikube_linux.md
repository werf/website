...
Чтобы разрешить Docker'у доступ в Registry по HTTP, в файле, по умолчанию находящемся в `/etc/docker/daemon.json`, добавим в ключ `insecure-registries` адрес нашего Registry:
```json
{
