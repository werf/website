...
>_Кстати, дальнейшие инструкции останутся актуальными и при использовании БД, которые развернуты другими способами — например, с помощью Amazon RDS._
...
## Проверка работы приложения с БД
