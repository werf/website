...
func newRouter() *mux.Router {
	...
	r.PathPrefix("/documentation/v{version:[0-9]+.[0-9]+.[0-9]+[^/]*}").HandlerFunc(unknownVersionHandler)
	r.PathPrefix("/documentation/v{group:[0-9]+}/").HandlerFunc(groupHandler)
	r.PathPrefix("/documentation/v{group:[0-9]+.[0-9]+}/").HandlerFunc(groupHandler)
	r.PathPrefix("/documentation/{group:latest}/").HandlerFunc(groupHandler)
